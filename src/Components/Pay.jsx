...
function Pay() {
  ...
  const { setShowPay, showPay } = useUserData();
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-40">
      <div className="bg-white max-w-md w-full mx-4 p-6 rounded-lg shadow-lg relative">
        <div
          className="text-3xl rounded-full bg-gega-grey w-10 h-10 text-center cursor-pointer absolute m-2 -top-5 -right-5"
